...
func base58encoder(bytes []byte) (string, error) {
...
func GenerateshorlUrl(originalurl string) (string, error) {
	...
	shorturl, err := base58encoder([]byte(fmt.Sprintf("%d", generatenumber)))
